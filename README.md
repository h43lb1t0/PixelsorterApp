...
## AI Usage
LLMs are used as an coding assistant. No agentic tools are used to autotomatically generate code without human intervention. All architectural decisions are made by the author of this software. See [CONTRIBUTING.md](CONTRIBUTING.md) for more information.
